  <div class="card">
                                    ...
                                    <form action="{{route('admin.add.menu')}}" id="menu-save-form">
                                    	@csrf
                                    	<div class="row">
                                    		<div class="col-md-6">
		                                    <div class="mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text"  name="route" id="parent-route" class="form-control" >
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="model_name" id="parent-model_name" class="form-control" >
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <select  id="parent-parent_id" name="parent_id" class="form-select">
                                                    ...
                                                    <option value="{{$menu_item->id}}">@lang($menu_item->language_file_name.'.'.$menu_item->title)</option>
                                          ...
                                          <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <select  id="parent-menu_id" name="menu_id" class="form-select">
                                                	<option value=" " selected >@lang('label.choose')</option>
                                                	@foreach($parent_menu_lists as $parent_menu_list)
                                                    <option value="{{$parent_menu_list->id}}"> {{strtoupper($parent_menu_list->name)}}</option>
                                                    @endforeach
                                                </select>
