   <form action="{{route('admin.add.group_class')}}" id="menu-save-form">
  <div class="card">
                                    	...
                                    	<div class="row">
                                          ...
                                          <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text"  name="number" id="parent-number" class="form-control" >
                                                <div class="error d-none" id="error-number">
                                                    ...
                                                    <div class="col-md-6">
                                            <div class="mb-3">
                                                <label  id="label-description"  class="form-label">@lang('label.class_name')</label>
                                                 <select name="class_id" class="select2 form-control select2-multiple" multiple="multiple" data-placeholder="Choose ...">
