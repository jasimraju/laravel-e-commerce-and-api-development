                            ...
                            <div class="card-body">
                                ...
                                <table id="datatable-buttons" class="table align-middle table-nowrap table-hover">
                                    ...
                                    <tr>
                                    	...
                                    	<td class="table_description">{{$department->description}}</td>
...
data-url="{{route('admin.add.deptartment',$department->id)}}" data-viewport="main-sub-view" class="text-success"><i class="mdi mdi-pencil font-size-18"></i></a>
                                                 </li>
                                                                <li class="list-inline-item px-2">
