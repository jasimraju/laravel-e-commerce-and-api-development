...
@endif
                              ...
                              <form method="POST" id="login-form" action="{{ route('front.log.request_restpassword') }}">
                        @csrf
                                ...
                                @enderror
                                 ...
                                 <div class="shopping-cart-button mt-5 justify-content-center w-100">
                                                   <a href="javascript:void(0)"  onclick="submitDetailsForm(this)"  class="gradient-style-2" data-form-id="#login-form">{{ __('Reset_password') }}</a>
                                                </div>
